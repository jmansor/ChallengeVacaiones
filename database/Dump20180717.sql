...
CREATE TABLE `roles` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idrolesid_UNIQUE` (`id`)
...
INSERT INTO `roles` VALUES (1,'User'),(2,'Admin'),(3,'Visitor');
...
INSERT INTO `users` VALUES (6,'sebastian','sebastianbadaro@gmail.com','$2y$10$gozRbjf8M0p.uGMUXmyGn.Mt9veOyXg/TRsXBq44Z7RRinz8hoFBe',NULL,1,'2000-01-01'),(11,'Admin','admin@movies.com','$2y$10$paloSnVrZvW6NQeDNMtvCOfCzGlQR31lwXU4mjRY9D37weRc6XMLW',NULL,2,'2000-01-01'),(12,'fran','fran@gmail.com','$2y$10$157xyYU5yOxdhaa8lV74NuYPVhgvxAzWMF4ZudNfGAz4tiOp5sJqy',NULL,1,'2000-01-01');
...
-- Dump completed on 2018-07-17 23:23:45
